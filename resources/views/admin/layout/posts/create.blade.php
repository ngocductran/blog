...
<!-- Page Content -->
<div class="container">
    <form class="text-left" method="POST" enctype="multipart/form-data" action="{{route('admin.create.post')}}">
        {{ csrf_field() }}
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <textarea name="content" id="demo" class="form-control ckeditor">{{ old('content')}}</textarea>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select name="category" class="form-control">
                    ...
                    @foreach($cate as $val))
                        <option value="{{ $val->id }}" {{old('category') == $val->id?'selected':false}}>{{ $val->category }}</option>
                    @endforeach
                </select>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <img style="height: 80px;" class="img-fluid" id="pic"/>
            </div>
        </div>
